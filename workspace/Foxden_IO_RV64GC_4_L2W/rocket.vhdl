...
architecture Behavioral of FoxdenSystem is
    ...
    port (
        ...
        nmi_0_rnmi                          : in  std_logic;
        nmi_0_rnmi_interrupt_vector         : in  std_logic_vector(33 downto 0);
        nmi_0_rnmi_exception_vector         : in  std_logic_vector(33 downto 0);
        nmi_1_rnmi                          : in  std_logic;
        nmi_1_rnmi_interrupt_vector         : in  std_logic_vector(33 downto 0);
        nmi_1_rnmi_exception_vector         : in  std_logic_vector(33 downto 0);
        nmi_2_rnmi                          : in  std_logic;
        nmi_2_rnmi_interrupt_vector         : in  std_logic_vector(33 downto 0);
        nmi_2_rnmi_exception_vector         : in  std_logic_vector(33 downto 0);
        nmi_3_rnmi                          : in  std_logic;
        nmi_3_rnmi_interrupt_vector         : in  std_logic_vector(33 downto 0);
        nmi_3_rnmi_exception_vector         : in  std_logic_vector(33 downto 0);
        interrupts                          : in  std_logic_vector(7 downto 0));
    end component FoxdenSystem;
...
begin
    ...
    rocket_system : component FoxdenSystem
    port map (
        clock                                => clock,
        reset                                => riscv_reset,
        ...
        nmi_2_rnmi                           => nmi_2_rnmi,
        nmi_2_rnmi_interrupt_vector          => nmi_2_rnmi_interrupt_vector,
        nmi_2_rnmi_exception_vector          => nmi_2_rnmi_exception_vector,
        nmi_3_rnmi                           => nmi_3_rnmi,
        nmi_3_rnmi_interrupt_vector          => nmi_3_rnmi_interrupt_vector,
        nmi_3_rnmi_exception_vector          => nmi_3_rnmi_exception_vector,
